...
class Module extends \yii\base\Module implements BootstrapInterface
{
     ...
     * {@inheritdoc}
     */
    public $controllerNamespace = 'sankaest\gii\controllers';
    /**
    ...
    public function bootstrap($app)
    {
        if ($app instanceof \yii\web\Application) {
            ...
            $app->controllerMap[$this->id] = [
                'class' => 'sankaest\gii\console\GenerateController',
    ...
    {
        return [
            'model' => ['class' => 'sankaest\gii\generators\model\Generator'],
            'crud' => ['class' => 'sankaest\gii\generators\crud\Generator'],
            'controller' => ['class' => 'sankaest\gii\generators\controller\Generator'],
            'form' => ['class' => 'sankaest\gii\generators\form\Generator'],
            'module' => ['class' => 'sankaest\gii\generators\module\Generator'],
            'extension' => ['class' => 'sankaest\gii\generators\extension\Generator'],
        ];
    }
